...
var A = mongoose.model('A', new Schema({ depth: String, created:Date, site: String,description:String}),'sesmicinfo_quakedetail' );
...
app.get('/checkhealth', function(req, res) {
	...
	res.send({"status":"healthy","nodeid":"sam:rn:0001"}); 
});
